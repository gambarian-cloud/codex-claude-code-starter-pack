...
A GitHub repo is not proof that something is installable and maintained. A package on PyPI with weekly downloads is stronger adoption evidence than a repo with 1,000 stars and no package.
...
3. A tool on a registry with active downloads > a repo with stars but no package
