...
$allGood = (Test-Check "Codex skill hebrew-pdf-to-markdown" { Test-Path (Join-Path $codexRoot "skills\hebrew-pdf-to-markdown\SKILL.md") }) -and $allGood
$allGood = (Test-Check "Claude skill hebrew-pdf-to-markdown" { Test-Path (Join-Path $claudeRoot "skills\hebrew-pdf-to-markdown\SKILL.md") }) -and $allGood
...
if ($Profile -in @("websites", "simple-apps")) {
  ...
  $allGood = (Test-Check "Claude skill vercel-deploy" { Test-Path (Join-Path $claudeRoot "skills\vercel-deploy\SKILL.md") }) -and $allGood
}
